...
#define OPTION_MASK_ISA_PKU (HOST_WIDE_INT_1 << 40)
...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 1182,            /* -m128bit-long-double */
  OPT_m16 = 1183,                            /* -m16 */
  OPT_m32 = 1184,                            /* -m32 */
  OPT_m3dnow = 1185,                         /* -m3dnow */
  OPT_m3dnowa = 1186,                        /* -m3dnowa */
  OPT_m64 = 1187,                            /* -m64 */
  OPT_m80387 = 1188,                         /* -m80387 */
  OPT_m8bit_idiv = 1189,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1190,             /* -m96bit-long-double */
  OPT_mabi_ = 1191,                          /* -mabi= */
  OPT_mabm = 1192,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1193,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1194,                 /* -maddress-mode= */
  OPT_madx = 1195,                           /* -madx */
  OPT_maes = 1196,                           /* -maes */
  OPT_malign_data_ = 1197,                   /* -malign-data= */
  OPT_malign_double = 1198,                  /* -malign-double */
  OPT_malign_functions_ = 1199,              /* -malign-functions= */
  OPT_malign_jumps_ = 1200,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1201,                  /* -malign-loops= */
  OPT_malign_stringops = 1202,               /* -malign-stringops */
  OPT_mandroid = 1203,                       /* -mandroid */
  OPT_march_ = 1204,                         /* -march= */
  OPT_masm_ = 1205,                          /* -masm= */
  OPT_mavx = 1206,                           /* -mavx */
  OPT_mavx2 = 1207,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1208,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1209,  /* -mavx256-split-unaligned-store */
  ...
  OPT_mavx512vl = 1218,                      /* -mavx512vl */
  OPT_mbionic = 1219,                        /* -mbionic */
  OPT_mbmi = 1220,                           /* -mbmi */
  OPT_mbmi2 = 1221,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1222,                  /* -mbranch-cost= */
  OPT_mcld = 1223,                           /* -mcld */
  OPT_mclflushopt = 1224,                    /* -mclflushopt */
  OPT_mclwb = 1225,                          /* -mclwb */
  OPT_mclzero = 1226,                        /* -mclzero */
  OPT_mcmodel_ = 1227,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1228, */                    /* -mcpu= */
  OPT_mcrc32 = 1229,                         /* -mcrc32 */
  OPT_mcx16 = 1230,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1231,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1232,            /* -mdump-tune-features */
  OPT_mf16c = 1233,                          /* -mf16c */
  OPT_mfancy_math_387 = 1234,                /* -mfancy-math-387 */
  OPT_mfentry = 1235,                        /* -mfentry */
  OPT_mfma = 1236,                           /* -mfma */
  OPT_mfma4 = 1237,                          /* -mfma4 */
  OPT_mforce_drap = 1238,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1239,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1240,                       /* -mfpmath= */
  OPT_mfsgsbase = 1241,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1242, */              /* -mfused-madd */
  OPT_mfxsr = 1243,                          /* -mfxsr */
  OPT_mglibc = 1244,                         /* -mglibc */
  OPT_mhard_float = 1245,                    /* -mhard-float */
  OPT_mhle = 1246,                           /* -mhle */
  OPT_miamcu = 1247,                         /* -miamcu */
  OPT_mieee_fp = 1248,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1249,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1250,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1251,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1252, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1253,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1254,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1255,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1256,                /* -mlong-double-80 */
  OPT_mlwp = 1257,                           /* -mlwp */
  OPT_mlzcnt = 1258,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1259,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1260,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1261,                  /* -mmitigate-rop */
  OPT_mmmx = 1262,                           /* -mmmx */
  OPT_mmovbe = 1263,                         /* -mmovbe */
  OPT_mmpx = 1264,                           /* -mmpx */
  OPT_mms_bitfields = 1265,                  /* -mms-bitfields */
  OPT_mmusl = 1266,                          /* -mmusl */
  OPT_mmwaitx = 1267,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1268,            /* -mno-align-stringops */
  OPT_mno_default = 1269,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1270,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1271,                  /* -mno-push-args */
  OPT_mno_red_zone = 1272,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1273,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1274,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1275,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1276,                          /* -mpc32 */
  OPT_mpc64 = 1277,                          /* -mpc64 */
  OPT_mpc80 = 1278,                          /* -mpc80 */
  OPT_mpclmul = 1279,                        /* -mpclmul */
  OPT_mpcommit = 1280,                       /* -mpcommit */
  OPT_mpku = 1281,                           /* -mpku */
  OPT_mpopcnt = 1282,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1283,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1284,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1285,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1286,                        /* -mprfchw */
  OPT_mpush_args = 1287,                     /* -mpush-args */
  OPT_mrdrnd = 1288,                         /* -mrdrnd */
  OPT_mrdseed = 1289,                        /* -mrdseed */
  OPT_mrecip = 1290,                         /* -mrecip */
  OPT_mrecip_ = 1291,                        /* -mrecip= */
  OPT_mrecord_mcount = 1292,                 /* -mrecord-mcount */
  OPT_mred_zone = 1293,                      /* -mred-zone */
  OPT_mregparm_ = 1294,                      /* -mregparm= */
  OPT_mrtd = 1295,                           /* -mrtd */
  OPT_mrtm = 1296,                           /* -mrtm */
  OPT_msahf = 1297,                          /* -msahf */
  OPT_msha = 1298,                           /* -msha */
  OPT_mskip_rax_setup = 1299,                /* -mskip-rax-setup */
  OPT_msoft_float = 1300,                    /* -msoft-float */
  OPT_msse = 1301,                           /* -msse */
  OPT_msse2 = 1302,                          /* -msse2 */
  OPT_msse2avx = 1303,                       /* -msse2avx */
  OPT_msse3 = 1304,                          /* -msse3 */
  OPT_msse4 = 1305,                          /* -msse4 */
  OPT_msse4_1 = 1306,                        /* -msse4.1 */
  OPT_msse4_2 = 1307,                        /* -msse4.2 */
  OPT_msse4a = 1308,                         /* -msse4a */
  /* OPT_msse5 = 1309, */                    /* -msse5 */
  OPT_msseregparm = 1310,                    /* -msseregparm */
  OPT_mssse3 = 1311,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1312,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1313,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1314,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1315,            /* -mstringop-strategy= */
  OPT_mstv = 1316,                           /* -mstv */
  OPT_mtbm = 1317,                           /* -mtbm */
  OPT_mtls_dialect_ = 1318,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1319,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1320,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1321,                         /* -mtune= */
  OPT_muclibc = 1322,                        /* -muclibc */
  OPT_mveclibabi_ = 1323,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1324,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1325,                    /* -mvzeroupper */
  OPT_mx32 = 1326,                           /* -mx32 */
  OPT_mxop = 1327,                           /* -mxop */
  OPT_mxsave = 1328,                         /* -mxsave */
  OPT_mxsavec = 1329,                        /* -mxsavec */
  OPT_mxsaveopt = 1330,                      /* -mxsaveopt */
  OPT_mxsaves = 1331,                        /* -mxsaves */
  OPT_n = 1332,                              /* -n */
  OPT_no_canonical_prefixes = 1333,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1334,              /* -no-integrated-cpp */
  OPT_no_pie = 1335,                         /* -no-pie */
  OPT_nocpp = 1336,                          /* -nocpp */
  OPT_nodefaultlibs = 1337,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1338,                   /* -nostartfiles */
  OPT_nostdinc = 1339,                       /* -nostdinc */
  OPT_nostdinc__ = 1340,                     /* -nostdinc++ */
  OPT_nostdlib = 1341,                       /* -nostdlib */
  OPT_o = 1342,                              /* -o */
  OPT_p = 1343,                              /* -p */
  OPT_pass_exit_codes = 1344,                /* -pass-exit-codes */
  /* OPT_pedantic = 1345, */                 /* -pedantic */
  OPT_pedantic_errors = 1346,                /* -pedantic-errors */
  OPT_pg = 1347,                             /* -pg */
  OPT_pie = 1348,                            /* -pie */
  OPT_pipe = 1349,                           /* -pipe */
  OPT_posix = 1350,                          /* -posix */
  OPT_print_file_name_ = 1351,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1352,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1353,          /* -print-multi-directory */
  OPT_print_multi_lib = 1354,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1355,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1356,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1357,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1358,               /* -print-prog-name= */
  OPT_print_search_dirs = 1359,              /* -print-search-dirs */
  OPT_print_sysroot = 1360,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1361,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1362,                        /* -profile */
  OPT_pthread = 1363,                        /* -pthread */
  OPT_quiet = 1364,                          /* -quiet */
  OPT_r = 1365,                              /* -r */
  OPT_rdynamic = 1366,                       /* -rdynamic */
  OPT_remap = 1367,                          /* -remap */
  OPT_s = 1368,                              /* -s */
  OPT_s_bc_abi = 1369,                       /* -s-bc-abi */
  OPT_save_temps = 1370,                     /* -save-temps */
  OPT_save_temps_ = 1371,                    /* -save-temps= */
  OPT_shared = 1372,                         /* -shared */
  OPT_shared_libgcc = 1373,                  /* -shared-libgcc */
  /* OPT_specs = 1374, */                    /* -specs */
  OPT_specs_ = 1375,                         /* -specs= */
  OPT_static = 1376,                         /* -static */
  OPT_static_libasan = 1377,                 /* -static-libasan */
  OPT_static_libgcc = 1378,                  /* -static-libgcc */
  OPT_static_libgcj = 1379,                  /* -static-libgcj */
  OPT_static_libgfortran = 1380,             /* -static-libgfortran */
  OPT_static_libgo = 1381,                   /* -static-libgo */
  OPT_static_liblsan = 1382,                 /* -static-liblsan */
  OPT_static_libmpx = 1383,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1384,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1385,               /* -static-libstdc++ */
  OPT_static_libtsan = 1386,                 /* -static-libtsan */
  OPT_static_libubsan = 1387,                /* -static-libubsan */
  /* OPT_std_c__03 = 1388, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1389, */                /* -std=c++0x */
  OPT_std_c__11 = 1390,                      /* -std=c++11 */
  OPT_std_c__14 = 1391,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1392, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1393, */                /* -std=c++1y */
  OPT_std_c__1z = 1394,                      /* -std=c++1z */
  OPT_std_c__98 = 1395,                      /* -std=c++98 */
  OPT_std_c11 = 1396,                        /* -std=c11 */
  /* OPT_std_c1x = 1397, */                  /* -std=c1x */
  /* OPT_std_c89 = 1398, */                  /* -std=c89 */
  OPT_std_c90 = 1399,                        /* -std=c90 */
  OPT_std_c99 = 1400,                        /* -std=c99 */
  /* OPT_std_c9x = 1401, */                  /* -std=c9x */
  OPT_std_f2003 = 1402,                      /* -std=f2003 */
  OPT_std_f2008 = 1403,                      /* -std=f2008 */
  OPT_std_f2008ts = 1404,                    /* -std=f2008ts */
  OPT_std_f95 = 1405,                        /* -std=f95 */
  OPT_std_gnu = 1406,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1407, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1408, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1409,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1410,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1411, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1412, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1413,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1414,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1415,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1416, */                /* -std=gnu1x */
  ...
  OPT_symbolic = 1427,                       /* -symbolic */
  OPT_t = 1428,                              /* -t */
  OPT_time = 1429,                           /* -time */
  OPT_time_ = 1430,                          /* -time= */
  OPT_tno_android_cc = 1431,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1432,                 /* -tno-android-ld */
